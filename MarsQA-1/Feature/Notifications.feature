...
Scenario: 01 Check if user is able to click on "Notification"
...
Scenario: 02 Check if user is able to click on "Notification"->"Mark all as read"
...
Scenario: 03 Check if user is able to click on "Notification"->"See all"
	Given User Clicks on the Notification button
	When Clicks on the See all button
	Then The user should be able to navigate to the dashboard Page

Scenario: 04 Check if user is able to click on "Load more"
	Given User Clicks on the Notification button
...
Scenario: 04 Check if user is able to click on "Show Less"
	Given User Clicks on the Notification button
	And Clicks on the See all button
...
Scenario: 05 Check if user is able to mark a single notification as read
	Given User Clicks on the Notification button
	And Clicks on the See all button
...
Scenario: 06 Check if user is able to mark multiple notifications as read
	Given User Clicks on the Notification button
	And Clicks on the See all button
...
Scenario: 07 Check if user is able to click on Select All
	Given User Clicks on the Notification button
	And Clicks on the See all button
...
Scenario: 08 Check if user is able to click on Unselect all when all notifications are selected
	Given User Clicks on the Notification button
	And Clicks on the See all button
	And Clicks on Select all
...
Scenario: 09 Check if user is able to Delete for single notification
	Given User Clicks on the Notification button
	And Clicks on the See all button
	And Ticks a notification Item
...
Scenario: 10 Check if user is able to Delete for multiple notifications
	Given User Clicks on the Notification button
	And Clicks on the See all button
...
Scenario: 11 Check if user is able to delete all notifications
	Given User Clicks on the Notification button
	And Clicks on the See all button
